...
target_host = 'llvm -target=arm64-linux-gnu'
...
tuning_option = {
    ...
    'measure_option': autotvm.measure_option(
        ...
        runner=autotvm.RPCRunner(
            ...
            '0.0.0.0', 9090,
            number=1, repeat=3, timeout=4, min_repeat_ms=150)
    ),
}
...
def main():
    ...
    tasks = autotvm.task.extract_from_program(mod["main"], target=target, params=params, ops=(relay.op.nn.conv2d, relay.op.nn.dense,))
    ...
    with autotvm.apply_history_best(log_file):
        ...
        with relay.build_config(opt_level=3):
            ...
            remote = autotvm.measure.request_remot(device_key, '0.0.0.0', 9090, timeout=10000)
